...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/dogpile.cache-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/dogpile.cache-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add dogpile.cache
# for installing globally
pixi global install dogpile.cache
```
...
It is possible to list all of the versions of `dogpile.cache` available on your platform:
...
```
mamba search dogpile.cache --channel conda-forge
```
...
```
pixi search dogpile.cache --channel conda-forge
```
...
mamba repoquery search dogpile.cache --channel conda-forge

# List packages depending on `dogpile.cache`:
mamba repoquery whoneeds dogpile.cache --channel conda-forge

# List dependencies of `dogpile.cache`:
mamba repoquery depends dogpile.cache --channel conda-forge
```
